...
MODEL_PATHS=(
    ["llava_7b"]="../Wparam_dataset/hf_model/llava-hf--llava-1.5-7b-hf"
)

declare -A HESS_PATHS
HESS_PATHS=(
    ["llava_7b"]="../Wparam_dataset/quip_hess/llava-hf--llava-1.5-7b-hf_512"
)
...
for model_key in "${MODELS_TO_RUN[@]}"; do
    ...
    for exp_type in "${EXP_TYPES_TO_RUN[@]}"; do
        ...
        for K in 2 3 4 5 6; do
            ...
            python -m quantize_llama.hfize_llava \
