...
def main(args):
    ...
    def load_clip_block(prefix, layers, orig_layers):
        for i in range(len(layers)):
            ...
            load_proj_or_restore(layer.attention.attention, 'query', f'{prefix}{i}', 'q', None, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.attention.attention, 'key', f'{prefix}{i}', 'k', None, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.attention.attention, 'value', f'{prefix}{i}', 'v', None, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.attention.output, 'dense', f'{prefix}{i}', 'o', None, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.mlp, 'fc1', f'{prefix}{i}', 'fc1', None, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.mlp, 'fc2', f'{prefix}{i}', 'fc2', None, args.quantized_path, skip_list, quip_params)
