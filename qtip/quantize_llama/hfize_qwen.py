...
from transformers import Qwen2ForCausalLM as OrigQwen2
...
def main(args):
    ...
    #                                        config=model_config)
    ## ryu
    model = Qwen2ForCausalLM.from_pretrained(args.base_model,
                                        torch_dtype='auto',
                                        low_cpu_mem_usage=True,
                                        config=model_config)
    
    orig_model = OrigQwen2.from_pretrained(args.base_model,
                                        torch_dtype='auto',
                                        low_cpu_mem_usage=True,
                                        config=model_config)
