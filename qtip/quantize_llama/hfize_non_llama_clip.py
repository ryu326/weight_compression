...
def main(args):
    ...
    def load_clip_block(prefix, layers, orig_layers):
        for i in range(len(layers)):
            ...
            load_proj_or_restore(layer.self_attn, 'q_proj', f'{prefix}_{i}', 'q', orig.self_attn, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.self_attn, 'k_proj', f'{prefix}_{i}', 'k', orig.self_attn, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.self_attn, 'v_proj', f'{prefix}_{i}', 'v', orig.self_attn, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.self_attn, 'out_proj', f'{prefix}_{i}', 'o', orig.self_attn, args.quantized_path, skip_list, quip_params)

            load_proj_or_restore(layer.mlp, 'fc1', f'{prefix}_{i}', 'fc1', orig.mlp, args.quantized_path, skip_list, quip_params)
            load_proj_or_restore(layer.mlp, 'fc2', f'{prefix}_{i}', 'fc2', orig.mlp, args.quantized_path, skip_list, quip_params)
