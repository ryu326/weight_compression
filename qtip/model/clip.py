...
class CLIPAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.k_proj = QuantizedLinear(self.embed_dim,
                                    self.embed_dim,
                                    td_x,
                                    td_y,
                                    L,
                                    ...
                                    bias=True)
        self.v_proj = QuantizedLinear(self.embed_dim,
                                    self.embed_dim,
                                    td_x,
                                    td_y,
                                    L,
                                    ...
                                    dtype=config.torch_dtype,
                                    bias=True)
        self.q_proj = QuantizedLinear(self.embed_dim,
                                    self.embed_dim,
                                    td_x,
                                    td_y,
                                    L,
                                    ...
                                    dtype=config.torch_dtype,
                                    bias=True)
        self.out_proj = QuantizedLinear(self.embed_dim,
                                    self.embed_dim,
                                    td_x,
                                    td_y,
                                    L,
...
class CLIPMLP(nn.Module):
    def __init__(self, config):
        ...
        self.fc1 = QuantizedLinear(config.hidden_size,
                                ...
                                dtype=config.torch_dtype,
                                bias=True)
        self.fc2 = QuantizedLinear(config.intermediate_size,
                                config.hidden_size,
                                td_x,
                                td_y,
                                L,
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def __init__(self, config: CLIPConfig):
        ...
        ##
        if 'quip_params' in config.to_dict():
            text_config.update({'quip_params': config.quip_params})
            vision_config.update({'quip_params': config.quip_params})
