...
for model_name in tqdm(model_list):
    ...
    try:
        tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir = cache_directory, token="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", trust_remote_code=True)
        # model = AutoModelForCausalLM.from_pretrained(model_name, cache_dir = cache_directory, token="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", trust_remote_code=True, force_download=True)
