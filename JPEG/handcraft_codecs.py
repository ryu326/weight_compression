""" 
 ...
 python handcraft_codecs.py /home/taco/VisDiff_for_compression/VisDiff/data/examples/set_a /home/taco/VisDiff_for_compression/Examples_Compressed/JPEG/set_a jp --bpp 0.1
 python handcraft_codecs.py /home/taco/VisDiff_for_compression/VisDiff/data/examples/set_a /home/taco/VisDiff_for_compression/Examples_Compressed/JPEG/set_a jp --bpp 0.6
 
 python handcraft_codecs.py /home/taco/VisDiff_for_compression/VisDiff/data/examples/set_b /home/taco/VisDiff_for_compression/Examples_Compressed/JPEG/set_b jp --bpp 0.1
 python handcraft_codecs.py /home/taco/VisDiff_for_compression/VisDiff/data/examples/set_b /home/taco/VisDiff_for_compression/Examples_Compressed/JPEG/set_b jp --bpp 0.6
...
myListms = [([0] * 24) for i in range(12)]
myListbpp = [([0] * 24) for i in range(12)]
cmms = [0] * 12
cmbpp = [0] * 12
# global row
# global accumlate
...
def jp2k_measure_over_interval(input_image_p, fout, bpp_grid):
    ...
    for bpp in bpp_grid:
        ...
        ssim, msssim, psnr = compare_imgs.compare(im_in, im_out, calc_ssim=True, calc_msssim=True, calc_psnr=True)
...
def jp2k_compress(input_image_p, out_dir, target_bpp, no_weights=True):
    output_image_j2_p = os.path.splitext(input_image_p)[0] + "_out_jp2.jp2"
    output_image_j2_p_save = f"{out_dir}/" + os.path.splitext(input_image_p)[0].split("/")[-1] + ".jpg"
    ...
    with remove_file_after(convert_im_to("bmp", input_image_p)) as input_image_bmp_p:
        cmd = [KDU_COMPRESS, "-i", input_image_bmp_p, "-o", output_image_j2_p, "-rate", str(target_bpp), "-no_weights"]
...
def convert_im_to(ext, input_image_p):
    ...
    # if ext == 'jpg_out_jp.jpg':
    #     input_image_root_p, _ = os.path.splitext(input_image_p+'_out_jp.jpg')
    #     im = Image.open(input_image_p+'_out_jp.jpg')
    #     input_image_ext_p = input_image_root_p + '__tmp.{}'.format(ext)
    #     im.save(input_image_p)
    # else:
    #     input_image_root_p, _ = os.path.splitext(input_image_p)
    #     im = Image.open(input_image_p)
    #     input_image_ext_p = input_image_root_p + '__tmp.{}'.format(ext)
...
# ------------------------------------------------------------------------------
### MSCOCO
# CUDA_VISIBLE_DEVICES=0 taskset -c 0-15 nohup python -u handcraft_codecs.py /data/MSCOCO/val2014 /home/hglee/Classic/COCO_Full/jpeg/0.5 jp --bpp 0.5 > jpeg_coco_0.5.txt 2>&1 &
# CUDA_VISIBLE_DEVICES=1 taskset -c 16-31 nohup python handcraft_codecs.py /data/MSCOCO/val2014 /home/hglee/Classic/COCO_Full/jpeg/0.4 jp --bpp 0.4 > jpeg_coco_0.4.txt 2>&1 &
# CUDA_VISIBLE_DEVICES=2 taskset -c 32-46 nohup python handcraft_codecs.py /data/MSCOCO/val2014 /home/hglee/Classic/COCO_Full/jpeg/0.3 jp --bpp 0.3 > jpeg_coco_0.3.txt 2>&1 &
# CUDA_VISIBLE_DEVICES=3 taskset -c 47-62 nohup python handcraft_codecs.py /data/MSCOCO/val2014 /home/hglee/Classic/COCO_Full/jpeg/0.2 jp --bpp 0.2 > jpeg_coco_0.2.txt 2>&1 &
# CUDA_VISIBLE_DEVICES=4 taskset -c 63-78 nohup nohup python handcraft_codecs.py /data/MSCOCO/val2014 /home/hglee/Classic/COCO_Full/jpeg/0.1 jp --bpp 0.1 > jpeg_coco_0.1.txt 2>&1 &
### Kodak
# nohup python handcraft_codecs.py /data/Kodak/kodak /home/hglee/Classic/Kodak/output/jpeg/0.5 jp --bpp 0.5 > jpeg_kodak_0.5.txt 2>&1 &
# nohup python handcraft_codecs.py /data/Kodak/kodak /home/hglee/Classic/CLIC2020/output/jpeg/0.4 jp --bpp 0.4 > jpeg_kodak_0.4.txt 2>&1 &
# nohup python handcraft_codecs.py /data/Kodak/kodak /home/hglee/Classic/CLIC2020/output/jpeg/0.3 jp --bpp 0.3 > jpeg_kodak_0.3.txt 2>&1 &
# nohup python handcraft_codecs.py /data/Kodak/kodak /home/hglee/Classic/CLIC2020/output/jpeg/0.2 jp --bpp 0.2 > jpeg_kodak_0.2.txt 2>&1 &
# nohup python handcraft_codecs.py /data/Kodak/kodak /home/hglee/Classic/Kodak/output/jpeg/0.1 jp --bpp 0.1 > jpeg_kodak_0.1.txt 2>&1 &
### CLIC2020
# nohup python handcraft_codecs.py /data/CLIC2020/test /home/hglee/Classic/CLIC2020/output/jpeg/0.5 jp --bpp 0.5 > jpeg_clic_0.5.txt 2>&1 &
# nohup python handcraft_codecs.py /data/CLIC2020/test /home/hglee/Classic/CLIC2020/output/jpeg/0.4 jp --bpp 0.4 > jpeg_clic_0.4.txt 2>&1 &
# nohup python handcraft_codecs.py /data/CLIC2020/test /home/hglee/Classic/CLIC2020/output/jpeg/0.3 jp --bpp 0.3 > jpeg_clic_0.3.txt 2>&1 &
# nohup python handcraft_codecs.py /data/CLIC2020/test /home/hglee/Classic/CLIC2020/output/jpeg/0.2 jp --bpp 0.2 > jpeg_clic_0.2.txt 2>&1 &
# nohup python handcraft_codecs.py /data/CLIC2020/test /home/hglee/Classic/CLIC2020/output/jpeg/0.1 jp --bpp 0.1 > jpeg_clic_0.1.txt 2>&1 &


def jp_compress(input_image_p, output_p, q):

    output_image_jp_p = f"{output_p}/" + os.path.splitext(input_image_p)[0].split("/")[-1] + ".jpg"
    print(f"{output_image_jp_p}")
...
def jp_compress_accurate(input_image_p, output_p, target_bpp, verbose=False):
    global row
    global accumlate

    jpeg_out_path = f"{output_p}/" + str(input_image_p.split("/")[-1])
    print(jpeg_out_path)
    out_path = f"{jpeg_out_path}" + "_out_jp.jpg"
    img = Image.open(f"{input_image_p}")
    ...
    for q in range(1, 99):
        ...
        if bpp > target_bpp:
            if verbose:
                ...
                actual_bpp, output_image_jp_p = jp_compress(f"{input_image_p}", output_p, q)
                # img.save(f'{output_p}'+str(input_image_p.split('/')[-1].split('_')[-1])+ '.png', quality=q, subsampling=0)
                # im_in = scipy.ndimage.imread(input_image_p)
                # im_out = scipy.ndimage.imread(output_image_jp_p)
                # ssim, msssim, psnr = compare_imgs.compare(
                # im_in, im_out, calc_ssim=True, calc_msssim=True, calc_psnr=True)
    ...
    # raise ValueError('Cannot achieve target bpp {} with JPEG for image {} (max {})'.format(target_bpp, input_image_p, bpp))
...
def jp2k_compress_accurate(input_image_p, out_dir, target_bpp, verbose=False, delta=0.005):
    for i in range(25):
        out_path, actual_bpp = jp2k_compress(input_image_p, out_dir, target_bpp + i * delta)
        if actual_bpp >= target_bpp:
            if verbose:
...
def bpg_measure(input_image_p, bpp, precise=False, save_output_as_png=None, tmp_dir=None):
    ...
    input_image_root_p, ext = os.path.splitext(input_image_p)
    assert ext == ".png", "Expected PNG to convert to BMP, got {}".format(input_image_p)
    output_image_bpg_p, actual_bpp = _bpg_compress_to_bpp(input_image_p, target_bpp=bpp, precise=precise)
    output_image_bpg_png_p = decode_bpg_to_png(output_image_bpg_p)
    os.remove(output_image_bpg_p)  # don't need that anymore

    _, msssim, _ = compare_imgs.compare(
        input_image_p, output_image_bpg_png_p, calc_ssim=False, calc_msssim=True, calc_psnr=False
    )
...
def _bpg_compress_to_bpp(input_image_p, target_bpp, precise=False, tmp_dir=None):
    ...
    try:
        ...
        output_image_bpg_p, q = binary_search(
            compress_input_image_with_quality,
            bpp_of_bpg_image,
            "decreasing",
            y_target=target_bpp,
            y_target_eps=bpp_eps,
            x_min=q_min,
            x_max=q_max,
            x_eps=0.1,
            log=False,
...
def binary_search(f, g, f_type, y_target, y_target_eps, x_min, x_max, x_eps, max_num_iter=1000, log=True):
    ...
    for _ in range(max_num_iter):
        ...
        _print(
            "[{:{width}.2f}, {:{width}.2f}] -- g(f({:{width}.2f})) = {:.2f}".format(
    ...
    if (f_type == "increasing" and first_y > last_y) or (f_type == "decreasing" and first_y < last_y):
        raise ValueError("Got f_type == {}, but first_y, last_y = {}, {}".format(f_type, first_y, last_y))
...
def check_if_programm_is_available(prg, name, env_name):
    try:
        subprocess.call([prg, "-v"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
def compress_to_bpp(root_dir, out_dir, target_bpp, mode):
    def target_p(img_, bpp_):
        return os.path.join(out_dir, os.path.splitext(os.path.basename(img_))[0] + ".jpg".format(mode, bpp_))
    ...
    for img in _get_image_paths(root_dir):
        ...
        if mode == "bpg":
            ...
            jp2k_p, actual_bpp = jp2k_compress_accurate(img, out_dir, target_bpp, verbose=True)
            with remove_file_after(jp2k_p):
                png_p = convert_im_to(".png", jp2k_p)
        elif mode == "jp":
            # output_p = out_dir
            try:
                jp_p, actual_bpp = jp_compress_accurate(img, out_dir, target_bpp, verbose=True)
                with remove_file_after(jp_p):
                    png_p = convert_im_to(".jpg", jp_p)
            except:
                jp_p = f"{out_dir}/" + str(img.split("/")[-1].split(".")[0] + ".") + "jpg_out_jp.jpg"
                with remove_file_after(jp_p):
                    png_p = convert_im_to(".jpg", jp_p)
...
def main():
    ...
    p.add_argument(
        "--gen_q", type=int, nargs="+", help="Only generate output for specific q. Only supported for " "modes == bpg."
    )
    p.add_argument(
        "--first_n", type=int, metavar="N", help="If given with --gen_q: only generate output for first N pics"
    )
    ...
    for bppi in bppx:
        for mode in flags.modes:
            # global row
            compress_to_bpp(flags.root_dir, flags.out_dir, target_bpp=bppi, mode=mode)
            cmms = np.mean(myListms, axis=1)
            cmbpp = np.mean(myListbpp, axis=1)
            row = row + 1
            accumlate = 0
            # print(cmms)
            # print(cmbpp)
