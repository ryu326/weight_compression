...
if __name__ == "__main__":
    ...
    save_directory = (
        f"/home/jgryu/Weight_compression/model_reconstructed/nwc/{args.direction}_recon_{os.path.join(*args.model_path.split('/')[-3:])}_MSE_{round(mse_total, 5)}_bpploss{round(bpp_loss, 5)}"
    )
