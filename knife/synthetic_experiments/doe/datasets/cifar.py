...
class CIFAR10(VisionDataset):
    ...
    def __init__(
        ...
        downloaded_list = self.test_list if split == "test" else self.train_list
        self.data: Any = []
        self.targets = []
        ...
        self.targets[targets == 2] = 1  # birds move to label 1
        self.targets[targets == 1] = 2  # autos move to label 2
        self.targets = self.targets[targets != 6]  # remove frog
        self.data = self.data[targets != 6]
        self.targets[self.targets > 6] -= 1  # Translate all classes avobe frog
