...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dpi", type=int, default=200, help="Dots per inch when saving the fig")
    ...
    parser.add_argument("--max_col", type=int, default=1, help="Maximum number of columns for legend")
...
def main(args: argparse.Namespace) -> None:
    plt.rc("font", size=args.fontsize, family=args.fontfamily, weight=args.fontweight)
