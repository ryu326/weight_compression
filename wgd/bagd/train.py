...
# python -m bagd.train --config bagd/configs/basic_gaussian.py --alsologtostderr

import tensorflow as tf
from absl import app, flags, logging
from bagd.main import Experiment
...
flags.DEFINE_integer(
    "hid", None, "ID of the hyperparameter configuration to use as defined in" "the config script's get_hyper()."
)
