...
quantize_flags=(
    ...
    "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond --scale_cond_test 0.1" 
    "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond --scale_cond_test 0.5" 
    "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond --scale_cond_test 1"
    "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond --scale_cond_test 2"
...
experiment_names=(
    ...
    "scaleH_std_ldlq128_scale_cond(col)_uniform31.6/test2_size128_encdim2048_M256"
