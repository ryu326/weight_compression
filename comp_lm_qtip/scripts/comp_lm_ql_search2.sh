    ...
    for layer_name in "${ql_search_layer_names[@]}"; do
        for ql_val in "${ql_search_values[@]}"; do
            ...
            python -m quantize_llama.quantize_finetune_llama --save_path $CKPT/$SAVE_NAME \
                ...
                --ql_search_layer_name q,k,v,o,up,gate,down \
                --ql_search_layer_idx $layer_name \
                --ft_epochs 0 \
