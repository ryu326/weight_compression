...
quantize_flags=(
    ...
    "--direction col --ql --Q 4 --use_codes --row_normalize"
...
experiment_names=(
    ...
    # "scaleH_std_ldlq128_scale_cond(col)/size128_encdim2048_M256_v2"
    # "scaleH_std_ldlq128_scale_cond(col)/size16_encdim512_M256_v2"
    # "test2_ql_rnorm"
)
##########################################################################
##                           MODEL CONFIGURATION                        ##
...
lmbda_values=(320 99 82 88 66 77 93 71)
##########################################################################
##                        MAIN EXECUTION LOOP                           ##
##########################################################################
