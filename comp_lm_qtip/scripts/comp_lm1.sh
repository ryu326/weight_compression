...
quantize_flags=(
    ...
    # "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond2" 
    # "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 128 --scale_cond2" 
    # "--direction row --scaleH --row_normalize --ldlq --comp_batch_size 16 --scale_cond"
    ...
    # "--direction col --ql --Q 4 --row_normalize --skip_list auto:upto=31,except=1_down"
    # "--direction col --ql --Q 4 --row_normalize --skip_list auto:upto=31,except=1_down"
    "--direction col --ql --Q 4 --layer_normalize --skip_list auto:upto=31,except=1_down"
...
experiment_names=(
    ...
    "ql_lnorm_lnorm_trained"
    # "ql_lnorm_trained"
    # "scale_cond3_rnorm_ldldq128/trained_rnormed_scale_cond(uniform50)"
    # "scale_cond3_rnorm_ldldq128/scale_cond(uniform50)"
)
##########################################################################
##                           MODEL CONFIGURATION                        ##
##########################################################################
