...
comp_model_base="/workspace/Weight_compression/NWC/checkpoint/nwc_qmap2/block_seq_qmap_scaler_meta-llama--Meta-Llama-3-8B__col_1024_gaussian_padding.pt/rdloss_qmap2_size16_encdim512_M17_Q0_R0_m0_batch_size2048_total_iter200000_lr0.0001_seed100/lmbda300_"
...
for qmap_v in "${qmap_value[@]}"; do
    ...
    SAVE_NAME=${model_name}/ql_qmap22/uniform${qmap_v}/lmbda300_
    # SAVE_NAME=${model_name}/ql_qmap2/lmbda50_hessian_ql
    # ## ========= Change this =========

    comp_model=$comp_model_base/best_loss*.pth.tar
...
# qmap_value=(2 1 0.5 0.1)
# for qmap_v in "${qmap_value[@]}"; do
#     echo "################## Running compression qmap_v=${qmap_v} ##################"
#     ## ========= Change this =========
#     # SAVE_NAME=${model_name}/ql_qmap2/lmbda50_hesssian_alpha${qmap_v}
#     SAVE_NAME=${model_name}/ql_qmap22/qmap_hesssian_alpha${qmap_v}
#     # ## ========= Change this =========
