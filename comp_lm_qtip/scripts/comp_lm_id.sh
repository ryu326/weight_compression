...
comp_model_bases=(
    ...
    # "../NWC/checkpoint/nwc_id/block_seq_ql_random_scaler_meta-llama--Meta-Llama-3-8B__col_1024_gaussian_padding.pt/rdloss_ql_size16_encdim512_M16_Q4_R0_m0_batch_size2048_total_iter200000_lr0.0001_seed100"
...
quantize_flags=(
    ...
    # "--direction col --ql --Q 4 --row_normalize --ql_search --ql_search_value 1"
