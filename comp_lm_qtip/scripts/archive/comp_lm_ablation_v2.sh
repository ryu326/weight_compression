...
# ##########################################################################
comp_model_bases=(
    # "../NWC/checkpoint/nwc_ql/block_seq_ql_random_scaler_meta-llama--Meta-Llama-3-8B__col_1024_gaussian_padding.pt/ablation_ql_rdloss_ql_v2_size16_encdim512_M16_Q4_R0_m0_batch_size2048_total_iter200000_lr0.0001_seed100"
    ...
    "../NWC/checkpoint/nwc_ql/block_seq_ql_random_scaler_meta-llama--Meta-Llama-3-8B__col_1024_gaussian_padding.pt/ablation_mse_rdloss_ql_mse_size16_encdim512_M16_Q4_R0_m0_batch_size2048_total_iter200000_lr0.0001_seed100"
)
quantize_flags=(
    "--direction col --ql --Q 4 --row_normalize --ldlq --comp_batch_size 128"
)
experiment_names=(
    "ql_ldlq128_rnorm_ablation_mse"
)
##########################################################################
##                           MODEL CONFIGURATION                        ##
##########################################################################
...
# lmbda_values=(10000 1000 300 100 50 30)
lmbda_values=(5 10 20)
##########################################################################
##                        MAIN EXECUTION LOOP                           ##
##########################################################################
...
experiment_names=(
    "ql_ldlq128_rnorm_ablation_mse_lr-5"
)
##########################################################################
##                           MODEL CONFIGURATION                        ##
##########################################################################
...
# 모든 실험에 공통으로 적용될 Lambda 값
lmbda_values=(10000 1000 100 50 30)
# lmbda_values=(5 10 20)
##########################################################################
##                        MAIN EXECUTION LOOP                           ##
##########################################################################
