...
#     # "--direction col --ql --Q 4 --row_normalize --ldlq --comp_batch_size 128 --ft_epochs 5 --ft_metadata --ft_rnorm"
# )
# experiment_names=(
#     # "ql_ldlq128_rnorm"
#     "ql_ldlq128_rnorm_ft_ft_rnorm"
# )
# ##########################################################################
# ##                           MODEL CONFIGURATION                        ##
# ##########################################################################
...
python -m eval.eval_zeroshot_hf \
    --tasks arc_challenge,arc_easy,winogrande,hellaswag,piqa \
    --batch_size 2 \
    --hf_path /workspace/Weight_compression/Wparam_dataset/hf_model/meta-llama--Llama-2-70b-hf_ \
    --output_path /workspace/Weight_compression/hf_model_comp_results/meta-llama--Llama-2-70b-hf_/base \