...
# SANE
from SANE.sampling.kde_sample_subsampled import sample_model_evaluation_subsampled
...
class CheckpointSamplingCallbackSubsampled(Callback):
    def __init__(
        self,
        ...
        """
        super(CheckpointSamplingCallbackSubsampled, self).__init__()
    ...
    def on_validation_epoch_end(self, ae_model, iteration) -> None:
        ...
        metrics_dict = sample_model_evaluation_subsampled(
            ae_model=ae_model,
