...
for i in "${!dim[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=1 python rdub_mlp_wp_per_tensor.py -V \
        --dataset /home/jgryu/Weight_compression/Wparam_dataset_v0/TFRecord/meta-llama--Meta-Llama-3-8B/per_tensor \
        ...
        --lambdas 1,13,146,2,24,270,4,43,500,7,79,3000 \
