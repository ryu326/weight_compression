...
# CUDA_VISIBLE_DEVICES=0 python -m quantize_llama.hessian_offline_llama --batch_size 2 --devset_size 6144 --ctx_size 2048 --base_model /home/jgryu/Weight_compression/Wparam_dataset/hf_model/meta-llama--Meta-Llama-3-8B --save_path $HESS/llama3_8b_6144
CUDA_VISIBLE_DEVICES=0 python -m quantize_llama.hessian_offline_llama --batch_size 2 --devset_size 6144 --ctx_size 2048 --base_model /home/jgryu/Weight_compression/Wparam_dataset/hf_model/meta-llama--Meta-Llama-3-8B --save_path $HESS/llama3.1_8b_6144
...
# CUDA_VISIBLE_DEVICES=0 python -m quantize_llama.quantize_finetune_llama --save_path $CKPT/2_7b_2bit --codebook E8P12  --scale_override 0.9 --base_model meta-llama/Llama-2-7b-hf  --hessian_path $HESS/llama2_7b_6144/ --devset_size 384 --ft_valid_size 128 >> $LOG/2_7b_2bit 2>&1
