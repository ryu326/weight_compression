...
def parse_args(argv):
    ...
    parser.add_argument("--u-length", type=int, default=4)
    ...
    parser.add_argument(
        "--dataset-path",
        type=str,
        default="/home/jgryu/Weight_compression/Wparam_dataset/dataset_2d/models--meta-llama--Meta-Llama-3-8B/mlp_attn__512_512_dataset.pt",
    )
    parser.add_argument(
        "--data_dim",
        type=int,
