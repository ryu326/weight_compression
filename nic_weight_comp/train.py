# nohup python -u train.py --model_name TCM --image_quality 1 --iter 2000000 --batch-size 8 --seed 100 --dist_port 6044 > ./training_logs/log_image_quality_1.txt 2>&1 &
        ...
        for i, (img) in enumerate(train_dataloader):
            ...
            if ((total_iter % 5000 == 0) or (total_iter == (1 * gpu_num))) and node_rank == 0:
                ...
                logger.info(
                    ...
                    f'\tMSE loss: {out_criterion["mse_loss"].mean().item():.6f} |'
...
def ddp_or_single_process(argvs):
    ...
    if opts.model_name == "TCM":
        ...
        elif opts.image_quality == 3:
            setattr(opts, "lmbda", 0.0067)
        elif opts.image_quality == 4:
            setattr(opts, "lmbda", 0.013)
        elif opts.image_quality == 5:
        ...
        if opts.image_quality == 1:
            ...
            setattr(opts, "lmbda", 0.0250)
        elif opts.image_quality == 3:
            setattr(opts, "lmbda", 0.0130)
        elif opts.image_quality == 4:
            setattr(opts, "lmbda", 0.0067)
        elif opts.image_quality == 5:
            setattr(opts, "lmbda", 0.0035)
        ...
        if opts.image_quality == 1:
            ...
            setattr(opts, "lmbda", 0.008)
        elif opts.image_quality == 3:
            setattr(opts, "lmbda", 0.016)
        elif opts.image_quality == 4:
            setattr(opts, "lmbda", 0.032)
        elif opts.image_quality == 5:
