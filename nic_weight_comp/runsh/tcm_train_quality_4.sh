#!/bin/sh
#SBATCH -J  tcm_hf_v4_4
#SBATCH -o  ./training_logs/%j.log_tcm_hf_v2_4.txt
#SBATCH -p  A5000
#SBATCH -t 72:00:00
#SBATCH   --gres=gpu:4
#SBATCH   --nodes=1
...
python -u $SAMPLES_DIR/train.py --model_name TCM --image_quality 4 --iter 2000000 --batch-size 8 --seed 100 --radius_denominator 8 --slurm --dist_port 8572
date
