#!/bin/sh
#SBATCH -J  elic_hf_v2_1
#SBATCH -o  ./training_logs/%j.log_elic_hf_v2_1.txt
#SBATCH -p  3090
#SBATCH -t 72:00:00
#SBATCH   --gres=gpu:4
#SBATCH   --nodes=1
...
python -u $SAMPLES_DIR/train.py --model_name ELIC --image_quality 1 --iter 2050000 --batch-size 8 --seed 100 --radius_denominator 8 --slurm --dist_port 7723
date
