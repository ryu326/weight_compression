...
for lmbda in "${lmbdas[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=7 taskset -c 48-63 python -u train_nwc.py \
        ...
        # --architecture nwc_ql \
        # --dataset_path ../Wparam_dataset/block_pt/meta-llama--Meta-Llama-3-8B_/col_1024_gaussian_padding.pt \
        # --dataset block_seq_ql_random \
        # --iter 200000 \
        # --input_size 16 \
        # --M 16 \
...
#         --architecture nwc_ql \
#         --dataset_path /workspace/Weight_compression/Wparam_dataset/block_pt/google--siglip-base-patch16-224/vision_text_col_256.pt \
#         --pretrained_path ./checkpoint/nwc_ql/block_seq_ql_random_scaler_meta-llama--Meta-Llama-3-8B__col_1024_gaussian_padding.pt/M16/lmbda${lmbda}_*/best_loss_model_*.pth.tar \
#         --run_name llama8b_pretrained \
#         --dataset block_seq_ql_random \
#         --iter 20000 \
...
#         --lmbda $lmbda --run_name aug_scale_p.1_M4 --aug_scale --aug_scale_p 0.1 --aug_scale_max 4   
        ...
        # --architecture nwc_scale_cond \
        # --dataset_path "/home/jgryu/workspace/weight_compression/Wparam_dataset/block_pt/meta-llama--Meta-Llama-3-8B/row_1024_whiten_scale_cond(col_std).pt" \
        # --dataset block_seq_scale_cond \
        # --iter 200000 \
        # --input_size 128 \
        # --M 256 \
